...
const Footer = () => {
  ...
  return (
   <div className="bg-[#243040] overflow-x-clip ">
      <div className="max-w-[1320px] mx-auto px-3">
        <div className="flex flex-row flex-wrap -mx-3 lg:py-[87px] md:pt-16 pt-10">
          <div className="lg:w-7/12 md:w-5/12 px-3 w-full">
            <div className="flex gap-[7px] items-center md:mb-[30px] sm:mb-5 mb-2" data-aos="fade-right">
              <img src={logo} alt="" />
              <p className=" font-roboto text-white md:text-[33.02px] text-2xl font-bold leading-normal">
                FURNITURE
              </p>
            </div>
            <p className="md:text-sm text-xs font-roboto font-normal leading-normal text-white max-w-[338px] mb-[23px] " data-aos="fade-left">
            ...
            <div className="flex gap-3" data-aos="fade-right">
              <a href="">
                <div className="w-[22.9px] h-[22.9px] bg-transparent border-white border rounded-full flex justify-center items-center hover:border-transparent group duration-300">
                  <svg
                    width="12"
                    height="12"
                    viewBox="0 0 23 23"
              ...
              <a href="">
                <div className="w-[22.9px] h-[22.9px] rounded-full border-white border border-solid bg-transparent hover:border-transparent group duration-300 flex justify-center items-center">
                  <svg
                    width="13"
                    height="11"
                    viewBox="0 0 13 11"
              ...
              <a href="">
                <div className="w-[22.9px] h-[22.9px] rounded-full flex justify-center items-center border-white border border-solid hover:border-transparent group bg-transparent duration-300">
                  <svg
                    width="8"
                    height="13"
                    viewBox="0 0 8 13"
          ...
          <div className="lg:w-5/12 md:w-7/12 px-3 w-full">
            <div className="flex flex-wrap flex-row -mx-3 md:pt-0 pt-5 ">
              <div className="sm:w-1/3 w-1/2   px-3"data-aos="flip-up">
                <ul>
              ...
              <div className="sm:w-1/3 w-1/2  px-3" data-aos="flip-down">
                <ul>
                  <li className="text-white font-roboto md:text-sm text-xs font-medium border-b  border-[#BD7D41] border-solid w-[130px] mb-[19px]">
                    BRANDS
                  </li>
      ...
      <div className="w-full border border-[#FFFFFF80] border-solid"></div>
      <p className=" font-roboto text-white text-center md:text-sm text font-normal leading-normal md:py-7 sm:py-5 py-4">
        @copyright{pika}
      </p>
    </div>
  );
