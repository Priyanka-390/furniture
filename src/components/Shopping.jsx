...
import first from "../assets/images/firstimg.webp";
import secimg from "../assets/images/secimg.webp";
import thirdimg from "../assets/images/thidimg.webp";
...
const Shopping = () => {
  ...
  return (
    <div className=" lg:pt-28 md:pt-20 sm:pt-16 pt-10 bg-[#F7F7F8] sec overflow-x-clip pb-24 relative z-[1]">
