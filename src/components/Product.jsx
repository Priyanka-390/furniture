...
const Product = () => {
    const carddata = data.map((data) => (
          <div className="lg:w-1/3 sm:w-1/2 w-full flex justify-center items-center  px-3 md:mt-10 mt-4">
          <div className="card md:px-6 px-4 transition-all duration-700 py-4 hover:shadow-[6px_13px_38px_0px_#0000001F]
              ...
              <span>
                ...
                >
                  ...
                  />
                      ...
                      <p className="text-[#000000B2] font-poppins mg:text-lg text-base font-normal md:pt-4 sm:pt-3 pt-1">Lorem ipsum dolor </p>
                      ...
                      <p className="text-black font-poppins xl:text-[28px] md:text-xl text-lg font-semibold">₹
                              1200.00</p>
                          <button className="lg:px-3 px-2 py-[10px] whitespace-nowrap text-white font-poppins lg:text-xl md:text-lg sm:text-base text-sm font-medium hover:text-[#BD7D41] shadow-[inset_0_18rem_0_0_#BD7D41] border-[2px] border-transparent hover:shadow-[inset_0_0_0_0] duration-500 hover:border-[#BD7D41]">ADD TO CART</button>
                      </div>
                      </div>
        </div>
    ))
    ...
    <div className="md:pt-20 sm:py-14 py-10 xl:pb-[169px] lg:pb-32 md:pb-20 overflow-x-clip">
      <div className="container max-w-[1320px] mx-auto px-3">
        <div className="sm:flex sm:justify-between justify-center flex-wrap items-center">
          ...
          <div className="max-sm:flex max-sm:justify-center sm:items-center" data-aos="fade-down-left">
