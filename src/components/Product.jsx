 ...
 bg-white shadow-[0px_0px_0px_0px_#0000001F]"
      >
        ...
        <div className="flex justify-between md:pt-4 pt-2 md:pb-12 pb-4  items-center">
          ...
          <button onClick={()=>showsidebar(data)} className="lg:px-3 px-2 py-[10px] whitespace-nowrap text-white font-poppins lg:text-xl md:text-lg sm:text-base text-sm font-medium hover:text-[#BD7D41] shadow-[inset_0_18rem_0_0_#BD7D41] border-[2px] border-transparent hover:shadow-[inset_0_0_0_0] duration-500 hover:border-[#BD7D41]">
            ADD TO CART
          </button>
        </div>
      </div>
  ...
  const shreya = sidebar.map((data, index) => (
    <div key={index}>
  ...
  return (
    <div className="md:pt-20 sm:py-14 py-10 xl:pb-[169px] lg:pb-32 md:pb-20 overflow-x-clip">
      ...
      <div className={`fixed left-0 top-0 w-full transition-all duration-500 px-5 max-w-[400px] h-full bg-[#685454] z-[40] overflow-y-auto  ${side ? "left-0" : "left-[-100%]"}`}> <button onClick={close} className="font-bold cursor-pointer text-4xl font-poppins text-white flex justify-end ml-auto">x</button>{shreya }</div>
    </div>
  );
};
